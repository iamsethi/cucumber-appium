...
public class WordPressLoginPage extends MobilePageObject {
	...
	public void enterInvalidEmailIdWPLoginPage() {
		WPEmailAddressField.sendKeys("ketan@invalid.com");
	}

	public boolean isErrorMessageShownWPLoginPage() {
		WPLogInPageNextButton.click();
		return WPLogInPageInvalidEmailErrorMessage.getText()
				.contains("we can't find a WordPress.com account connected to this email address");
	}
